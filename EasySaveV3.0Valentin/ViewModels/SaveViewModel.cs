...
namespace EasySaveV3._0.ViewModels
{
    class SaveViewModel : VMWorkspace
    {
        ...
        public ICommand ShowExecuteCommand { get; }
        public SaveViewModel()
        {
            ...
            ShowExecuteCommand = new RelayCommand(ExecSave, CanExecSave);
            /*
        ...
        private bool CanExecSave(object parameter)
        {
            return SelectedItem != null;
        }
        private void ExecSave(object obj)
        {
